                ...
                children: [
                  ...
                  Padding(
                    ...
                    child: Text(
                      ...
                      "\n✅ القرآن الكريم: تجربة متكاملة للاستماع والقراءة والبحث داخل المصحف، مع حفظ تقدّمك وتتبع وردك اليومي بسهولة."
                      "\n✅ مسابقة اذكاركم: سؤال جديد كل يوم وفرصة للتنافس والمشاركة مع الجميع في أجواء إيمانية مميزة."
                      "\n✅ مواقيت الصلاة: تعرّف بسهولة على الوقت المتبقي للصلاة القادمة، مع عرض جميع أوقات الصلوات بدقة + امكانية عرضها على الشاشة الرئيسية للهاتف."
                      "\n✅ اتجاه القبلة: اعرف اتجاه القبلة بكل سهولة، مع إمكانية تفعيل الكاميرا واستخدام تقنية الواقع المعزز."
                      "\n✅ أذكار الصباح والمساء: قسم خاص بأذكار الصباح والمساء وعرضه بطريقة فعالة ومرتبة بالإضافة إمكانية السماع للإذكار بالسرعة التي تفضلها مع تذكيرات يومية + تصميم نظام الإنجازات والتحفيز الذاتي."
